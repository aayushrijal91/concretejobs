					...
					<form action="./app/form.php" method="POST">
						...
						<div class="row no-gutters mb-2">
							<div class="col mr-lg-1">
								<input class="form-control border-0 rounded-0 bg-white" type="text" placeholder="Name" name="name" required>
							</div>
							<div class="col-12 col-lg-6 ml-lg-1 mt-2 mt-lg-0">
								<input class="form-control border-0 rounded-0 bg-white" type="tel" placeholder="Phone" name="phone" required>
							</div>
						</div>
						<div class="row no-gutters my-1">
							<div class="col mr-lg-1">
								<input class="form-control border-0 rounded-0 bg-white" type="email" placeholder="Email Address" name="email" required>
							</div>
							<div class="col-12 col-lg-6 ml-lg-1 mt-2 mt-lg-0">
						...
						<div class="row no-gutters my-2">
							<div class="col-12 col-lg-2 mr-lg-1">
								<input class="form-control border-0 rounded-0 bg-white" type="text" placeholder="Street Number" name="streetNumber" required>
							</div>
							<div class="col ml-lg-1 mt-2 my-lg-0">
								<input class="form-control border-0 rounded-0 bg-white" type="text" placeholder="Street Name" name="streetName" required>
							</div>
						</div>
						<div class="row no-gutters">
							<div class="col-12 col-lg-7 mr-lg-1">
								<input class="form-control border-0 rounded-0 bg-white" type="text" placeholder="Suburb" name="suburb" required>
							</div>
							<div class="col ml-lg-1 mt-2 mt-lg-0">
								<input class="form-control border-0 rounded-0 bg-white" type="number" placeholder="Postcode" name="postcode" required>
							</div>
						</div>
